...
const experienceProjectSchema = z.object({ name: z.string(), background: z.string().optional(), description: z.array(z.string()).optional(), highlights: z.array(z.string()).optional() });
const experienceSchema = z.object({ type: z.string().optional(), name: z.string().optional(), company: z.string().optional(), institution: z.string().optional(), facility: z.string().optional(), supervisor: z.string().optional(), position: z.string(), startDate: z.string(), endDate: z.string(), background: z.string().optional(), summary: z.string().optional(), description: z.array(z.string()).optional(), highlights: z.array(z.string()).optional(), projects: z.array(experienceProjectSchema).optional() });
const skillSchema = z.object({ name: z.string().optional(), category: z.string().optional(), keywords: z.array(z.string()) });
const projectSchema = z.object({ name: z.string(), link: z.string().optional(), startDate: z.string().optional(), endDate: z.string().optional(), background: z.string().optional(), description: z.array(z.string()).optional(), highlights: z.array(z.string()).optional() });
